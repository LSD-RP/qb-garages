...
Garages = {
    ...
    ["police"] = {
        label = "Police",
        takeVehicle = vector3(453.73, -1012.18, 28.47),
    ...
    ["boatgarage2"] = {
        label = "Elysian Island Boat Garage",
        takeVehicle = vector3(1297.98, -3305.84, 5.91),
        spawnPoint = vector4(1310.94, -3306.92, 0.45, 206.2),
        putVehicle = vector3(1310.94, -3306.92, 0.45),
        showBlip = true,
        blipName = "Boathouse",
        blipNumber = 356,
        type = 'public',                --public, job, gang, depot
    ...
    ["boatgarage3"] = {
        label = "Cayo Perico Boat Garage",
        takeVehicle = vector3(4932.73, -5176.03, 2.46),
        spawnPoint = vector4(4932.58, -5167.46, 0.15, 48.92),
        putVehicle = vector3(4932.58, -5167.46, 0.15),
        showBlip = true,
        blipName = "Boathouse",
        blipNumber = 356,
        type = 'public',                --public, job, gang, depot
    ...
    ["cayoperico"] = {
        ...
        takeVehicle = vector3(4982.97, -5153.64, 2.53),
        spawnPoint = vector4(4984.24, -5146.81, 2.5, 197.64),
        putVehicle = vector3(4984.24, -5146.81, 2.5),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
    ...
    ["cayopericoair"] = {
        label = "Cayo Perico Air Garage",
        takeVehicle = vector3(4496.96, -4506.64, 4.18),
        spawnPoint = vector4(4493.19, -4494.22, 4.19, 107.21),
        putVehicle = vector3(4493.19, -4494.22, 4.19),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 360,
        type = 'public',                --public, job, gang, depot
    ...
    ["cayoperico2"] = {
        label = "Cayo Perico Airport Parking",
        takeVehicle = vector3(4517.86, -4522.91, 4.222),
        spawnPoint = vector4(4510.99, -4519.16, 4.14, 12.14),
        putVehicle = vector3(4510.99, -4519.17, 4.14),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
    ...
    ["arena"] = {
        label = "FFA Arena Parking",
        takeVehicle = vector3(2766.66, -3903.61, 140.0),
        spawnPoint = vector4(2761.61, -3896.17, 140.01, 277.63),
        putVehicle = vector3(2763.35, -3895.94, 140.0),
        showBlip = false,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
    ...
    ["arenadepot"] = {
        label = "FFA Arena Depot",
        takeVehicle = vector3(2860.57, -3898.68, 140.0),
        spawnPoint = vector4(2858.19, -3894.3, 140.0, 5.23),
        showBlip = false,
        blipName = "Hayes Depot",
        blipNumber = 68,
        type = 'depot',                --public, job, gang, depot
    ...
    ["saltyshouse"] = {
        label = "Ace Jone Dr Parking",
        takeVehicle = vector3(-1756.75, 439.94, 128.9),
        spawnPoint = vector4(-1749.5, 442.74, 128.9, 182.63),
        putVehicle = vector3(-1749.5, 442.74, 128.9),
        showBlip = false,
        blipName = "Private Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicle = 'air'                 --car, air, sea
    },
